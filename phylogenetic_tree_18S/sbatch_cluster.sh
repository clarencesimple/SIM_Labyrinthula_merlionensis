...
# Submitted with 
# cd /shared/projects/geek_simple_laby/clarence/Laby_tree # Change to your directory
...
DIR="/shared/projects/geek_simple_laby/clarence/Laby_tree" # Change to your directory
FILE_HEAD="Labyrinthula_derep_sequences"
IDENTITY="0.99"
THREADS=4
